...
namespace MXEngine.Player.CoreUWP;
...
public sealed partial class App : IFrameworkViewSource, IFrameworkView
{
    ...
    public unsafe void Run()
    {
        ...
        buffer = new UWP.OpenGL.Framebuffer(ctx, (int)_window.Bounds.Width, (int)_window.Bounds.Height);
