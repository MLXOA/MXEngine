...
public unsafe class Framebuffer : FramebufferBase
{
    ...
    public override IDXGISwapChain1* SwapChainHandle { get; protected set; }
    ...
    public Framebuffer(RenderContext context, int framebufferWidth, int framebufferHeight)
    {
        ...
        // SwapChain
        {
            ...
            // convert the corewindow into an IUnknown for use with CreateSwapChainForCoreWindow.
            var coreWindow = (IUnknown*)Marshal.GetIUnknownForObject(CoreWindow.GetForCurrentThread());

            ((IDXGIFactory2*)Context.DxDeviceFactory)->CreateSwapChainForCoreWindow((IUnknown*)Context.DxDeviceHandle, coreWindow, &swapChainDesc, null, &swapChain);
    ...
    public void Begin()
    {
        ...
        // Texture2D
        {
            ...
            SwapChainHandle->GetBuffer(0, &guid, (void**)&colorbuffer);
        }
    ...
    public void UpdateSize(int framebufferWidth, int framebufferHeight)
    {
        ...
        SwapChainHandle->ResizeBuffers(2, (uint)framebufferWidth, (uint)framebufferHeight, Format.FormatUnknown, 0);
